...
/**
 * DE: Sortiert Tasks um und erhält dabei Reihenfolge und Daten aller anderen Karten.
 * EN: Reorders tasks while preserving the relative order and data of all other cards.
 * @param {Array} tasks - DE: Alle Tasks. EN: All tasks.
 * @param {string} taskId - DE: Verschobener Task. EN: Moved task.
 * @param {string} status - DE: Zielstatus. EN: Target status.
 * @param {string|null} beforeTaskId - DE: Task, vor dem eingefügt wird. EN: Task to insert before.
 * @returns {Array} DE: Neue Taskliste. EN: New task list.
 */
